...
DESIGN AND SIMULATION OF A CLOUD-BASED DISTRIBUTED MARKET INFORMATION SERVICE FOR CAMEROON
...
•	MFarm (Kenya): Mobile-based market information system for farmers.
...
<img width="900" height="600" alt="image" src="https://github.com/user-attachments/assets/9b443909-47b5-4160-904e-e352dbf7a442" />
...
•	Frontend: Flutter
•	Backend: Firebase Cloud Functions (Python or JavaScript)
•	Database: Firestore (NoSQL, real-time replication)
•	SMS/USSD Gateway: Africa’s Talking (supports both)
•	Testing Tools: Android Studio Emulator, Postman, Twilio Sandbox
